...
public class Mazzo {
    ...
    public static final String[] SEME_FRA={"Quadri","Cuori","Fiori","Picche"};
    public static final String[] NOME_FRA={"Asso","Due","Tre","Quattro","Cinque","Sei","Sette","Otto","Nove","Dieci","Jack","Donna","Re"};
    public static final String[] SEME_ITA={"Bastoni","Coppe","Denari","Spade"};
    ...
    Carta carta1 = new Carta(VALORE);
    Carta carta2 = new Carta(VALORE);
